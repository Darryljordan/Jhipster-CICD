...
/**
 * REST controller for managing {@link polytech.g6.blog.domain.Patient}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class PatientResource {
    ...
    public ResponseEntity<Patient> partialUpdatePatient(
        ...
        Optional<Patient> result = patientRepository
            ...
            .map(existingPatient -> {
                if (patient.getNomP() != null) {
                    existingPatient.setNomP(patient.getNomP());
                }
                if (patient.getPrenomP() != null) {
                    existingPatient.setPrenomP(patient.getPrenomP());
                }
                if (patient.getDateNaissanceP() != null) {
                    existingPatient.setDateNaissanceP(patient.getDateNaissanceP());
                }
                if (patient.getTailleP() != null) {
                    existingPatient.setTailleP(patient.getTailleP());
                }
                if (patient.getSexeP() != null) {
                    existingPatient.setSexeP(patient.getSexeP());
                }

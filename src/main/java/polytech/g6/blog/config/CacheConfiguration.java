...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, polytech.g6.blog.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, polytech.g6.blog.repository.UserRepository.USERS_BY_EMAIL_CACHE);

...
export const UtilisateurDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="nutriCareApp.utilisateur.delete.question">
        <Translate contentKey="nutriCareApp.utilisateur.delete.question" interpolate={{ id: utilisateurEntity.id }}>

...
export const EtablissementDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="nutriCareApp.etablissement.delete.question">
        <Translate contentKey="nutriCareApp.etablissement.delete.question" interpolate={{ id: etablissementEntity.id }}>

...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './chambre.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CHAMBRE_LIST actions', async () => {
    ...
    it('dispatches FETCH_CHAMBRE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CHAMBRE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CHAMBRE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CHAMBRE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CHAMBRE actions', async () => {
      const expectedActions = [
        {

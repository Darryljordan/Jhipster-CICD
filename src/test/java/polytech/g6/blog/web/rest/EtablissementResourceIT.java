...
class EtablissementResourceIT {
    ...
    private static final String DEFAULT_ADRESSE_E = "AAAAAAAAAA";
    private static final String UPDATED_ADRESSE_E = "BBBBBBBBBB";
    ...
    public static Etablissement createEntity(EntityManager em) {
        Etablissement etablissement = new Etablissement().nomE(DEFAULT_NOM_E).adresseE(DEFAULT_ADRESSE_E);
        // Add required entity
        Chambre chambre;
    ...
    public static Etablissement createUpdatedEntity(EntityManager em) {
        Etablissement etablissement = new Etablissement().nomE(UPDATED_NOM_E).adresseE(UPDATED_ADRESSE_E);
        // Add required entity
        Chambre chambre;
        if (TestUtil.findAll(em, Chambre.class).isEmpty()) {
    ...
    void createEtablissement() throws Exception {
        ...
        assertThat(testEtablissement.getAdresseE()).isEqualTo(DEFAULT_ADRESSE_E);
    }
    ...
    void getAllEtablissements() throws Exception {
        ...
        restEtablissementMockMvc
            ...
            .andExpect(jsonPath("$.[*].adresseE").value(hasItem(DEFAULT_ADRESSE_E)));
    }
    ...
    void getEtablissement() throws Exception {
        ...
        restEtablissementMockMvc
            ...
            .andExpect(jsonPath("$.adresseE").value(DEFAULT_ADRESSE_E));
    }
    ...
    void putExistingEtablissement() throws Exception {
        ...
        updatedEtablissement.nomE(UPDATED_NOM_E).adresseE(UPDATED_ADRESSE_E);
        ...
        assertThat(testEtablissement.getAdresseE()).isEqualTo(UPDATED_ADRESSE_E);
    }
    ...
    void partialUpdateEtablissementWithPatch() throws Exception {
        ...
        partialUpdatedEtablissement.adresseE(UPDATED_ADRESSE_E);
    ...
    void fullUpdateEtablissementWithPatch() throws Exception {
        ...
        partialUpdatedEtablissement.nomE(UPDATED_NOM_E).adresseE(UPDATED_ADRESSE_E);
